...
static struct bpf_helper_def {
	const char *name;
	const char *ret_type;
	int flags;
} bpf_helper_defs[] = {
	{"bpf_map_lookup_elem", "void *", FUNC_RET_PTR},
	{"bpf_map_update_elem", "long", 0},
	{"bpf_map_delete_elem", "long", 0},
	{"bpf_probe_read", "long", 0},
	{"bpf_ktime_get_ns", "__u64", FUNC_CANT_FAIL},
	{"bpf_trace_printk", "long", 0},
	{"bpf_get_prandom_u32", "__u32", FUNC_CANT_FAIL},
	{"bpf_get_smp_processor_id", "__bpf_fastcall__u32", FUNC_CANT_FAIL},
	{"bpf_skb_store_bytes", "long", 0},
	{"bpf_l3_csum_replace", "long", 0},
	{"bpf_l4_csum_replace", "long", 0},
	{"bpf_tail_call", "long", 0},
	{"bpf_clone_redirect", "long", 0},
	{"bpf_get_current_pid_tgid", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_current_uid_gid", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_current_comm", "long", 0},
	{"bpf_get_cgroup_classid", "__u32", FUNC_CANT_FAIL},
	{"bpf_skb_vlan_push", "long", 0},
	{"bpf_skb_vlan_pop", "long", 0},
	{"bpf_skb_get_tunnel_key", "long", 0},
	{"bpf_skb_set_tunnel_key", "long", 0},
	{"bpf_perf_event_read", "__u64" /* s64 */, 0},
	{"bpf_redirect", "long", 0},
	{"bpf_get_route_realm", "__u32", FUNC_CANT_FAIL},
	{"bpf_perf_event_output", "long", 0},
	{"bpf_skb_load_bytes", "long", 0},
	{"bpf_get_stackid", "long", 0},
	{"bpf_csum_diff", "__s64", FUNC_CANT_FAIL},
	{"bpf_skb_get_tunnel_opt", "long", 0},
	{"bpf_skb_set_tunnel_opt", "long", 0},
	{"bpf_skb_change_proto", "long", 0},
	{"bpf_skb_change_type", "long", 0},
	{"bpf_skb_under_cgroup", "long", 0},
	{"bpf_get_hash_recalc", "__u32", FUNC_CANT_FAIL},
	{"bpf_get_current_task", "struct task_struct *", FUNC_CANT_FAIL | FUNC_RET_PTR},
	{"bpf_probe_write_user", "long", 0},
	{"bpf_current_task_under_cgroup", "long", 0},
	{"bpf_skb_change_tail", "long", 0},
	{"bpf_skb_pull_data", "long", 0},
	{"bpf_csum_update", "__s64", FUNC_CANT_FAIL},
	{"bpf_set_hash_invalid", "void", FUNC_CANT_FAIL | FUNC_RET_VOID},
	{"bpf_get_numa_node_id", "long", FUNC_CANT_FAIL},
	{"bpf_skb_change_head", "long", 0},
	{"bpf_xdp_adjust_head", "long", 0},
	{"bpf_probe_read_str", "long", 0},
	{"bpf_get_socket_cookie", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_socket_uid", "__u32", FUNC_CANT_FAIL},
	{"bpf_set_hash", "long", 0},
	{"bpf_setsockopt", "long", 0},
	{"bpf_skb_adjust_room", "long", 0},
	{"bpf_redirect_map", "long", 0},
	{"bpf_sk_redirect_map", "long", 0},
	{"bpf_sock_map_update", "long", 0},
	{"bpf_xdp_adjust_meta", "long", 0},
	{"bpf_perf_event_read_value", "long", 0},
	{"bpf_perf_prog_read_value", "long", 0},
	{"bpf_getsockopt", "long", 0},
	{"bpf_override_return", "long", FUNC_CANT_FAIL},
	{"bpf_sock_ops_cb_flags_set", "long", 0},
	{"bpf_msg_redirect_map", "long", 0},
	{"bpf_msg_apply_bytes", "long", 0},
	{"bpf_msg_cork_bytes", "long", 0},
	{"bpf_msg_pull_data", "long", 0},
	{"bpf_bind", "long", 0},
	{"bpf_xdp_adjust_tail", "long", 0},
	{"bpf_skb_get_xfrm_state", "long", 0},
	{"bpf_get_stack", "long", 0},
	{"bpf_skb_load_bytes_relative", "long", 0},
	{"bpf_fib_lookup", "long", 0},
	{"bpf_sock_hash_update", "long", 0},
	{"bpf_msg_redirect_hash", "long", 0},
	{"bpf_sk_redirect_hash", "long", 0},
	{"bpf_lwt_push_encap", "long", 0},
	{"bpf_lwt_seg6_store_bytes", "long", 0},
	{"bpf_lwt_seg6_adjust_srh", "long", 0,},
	{"bpf_lwt_seg6_action", "long", 0,},
	{"bpf_rc_repeat", "long", 0},
	{"bpf_rc_keydown", "long", 0},
	{"bpf_skb_cgroup_id", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_current_cgroup_id", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_local_storage", "void *", FUNC_RET_PTR},
	{"bpf_sk_select_reuseport", "long", 0},
	{"bpf_skb_ancestor_cgroup_id", "__u64", FUNC_CANT_FAIL},
	{"bpf_sk_lookup_tcp", "struct bpf_sock *", FUNC_RET_PTR},
	{"bpf_sk_lookup_udp", "struct bpf_sock *", FUNC_RET_PTR},
	{"bpf_sk_release", "long", 0},
	{"bpf_map_push_elem", "long", 0},
	{"bpf_map_pop_elem", "long", 0},
	{"bpf_map_peek_elem", "long", 0},
	{"bpf_msg_push_data", "long", 0},
	{"bpf_msg_pop_data", "long", 0},
	{"bpf_rc_pointer_rel", "long", 0},
	{"bpf_spin_lock", "long", FUNC_CANT_FAIL},
	{"bpf_spin_unlock", "long", FUNC_CANT_FAIL},
	{"bpf_sk_fullsock", "struct bpf_sock *", FUNC_RET_PTR},
	{"bpf_tcp_sock", "struct bpf_tcp_sock *", FUNC_RET_PTR},
	{"bpf_skb_ecn_set_ce", "long", 0},
	{"bpf_get_listener_sock", "struct bpf_sock *", FUNC_RET_PTR},
	{"bpf_skc_lookup_tcp", "struct bpf_sock *", FUNC_RET_PTR},
	{"bpf_tcp_check_syncookie", "long", 0},
	{"bpf_sysctl_get_name", "long", 0},
	{"bpf_sysctl_get_current_value", "long", 0},
	{"bpf_sysctl_get_new_value", "long", 0},
	{"bpf_sysctl_set_new_value", "long", 0},
	{"bpf_strtol", "long", 0},
	{"bpf_strtoul", "long", 0},
	{"bpf_sk_storage_get", "void *", FUNC_RET_PTR},
	{"bpf_sk_storage_delete", "long", 0},
	{"bpf_send_signal", "long", 0},
	{"bpf_tcp_gen_syncookie", "__s64", 0},
	{"bpf_skb_output", "long", 0},
	{"bpf_probe_read_user", "long", 0},
	{"bpf_probe_read_kernel", "long", 0},
	{"bpf_probe_read_user_str", "long", 0},
	{"bpf_probe_read_kernel_str", "long", 0},
	{"bpf_tcp_send_ack", "long", 0},
	{"bpf_send_signal_thread", "long", 0},
	{"bpf_jiffies64", "__u64", FUNC_CANT_FAIL},
	{"bpf_read_branch_records", "long", 0},
	{"bpf_get_ns_current_pid_tgid", "long", 0},
	{"bpf_xdp_output", "long", 0},
	{"bpf_get_netns_cookie", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_current_ancestor_cgroup_id", "__u64", FUNC_CANT_FAIL},
	{"bpf_sk_assign", "long", 0},
	{"bpf_ktime_get_boot_ns", "__u64", FUNC_CANT_FAIL},
	{"bpf_seq_printf", "long", 0},
	{"bpf_seq_write", "long", 0},
	{"bpf_sk_cgroup_id", "__u64", FUNC_CANT_FAIL}, /* actually 0 is error condition */
	{"bpf_sk_ancestor_cgroup_id", "__u64", FUNC_CANT_FAIL}, /* actually 0 is error condition */
	{"bpf_ringbuf_output", "long", 0},
	{"bpf_ringbuf_reserve", "void *", FUNC_RET_PTR},
	{"bpf_ringbuf_submit", "void", FUNC_RET_VOID},
	{"bpf_ringbuf_discard", "void", FUNC_CANT_FAIL | FUNC_RET_VOID},
	{"bpf_ringbuf_query", "__u64", FUNC_CANT_FAIL},
	{"bpf_csum_level", "long", 0},
	{"bpf_skc_to_tcp6_sock", "struct tcp6_sock *", FUNC_RET_PTR},
	{"bpf_skc_to_tcp_sock", "struct tcp_sock *", FUNC_RET_PTR},
	{"bpf_skc_to_tcp_timewait_sock", "struct tcp_timewait_sock *", FUNC_RET_PTR},
	{"bpf_skc_to_tcp_request_sock", "struct tcp_request_sock *", FUNC_RET_PTR},
	{"bpf_skc_to_udp6_sock", "struct udp6_sock *", FUNC_RET_PTR},
	{"bpf_get_task_stack", "long", 0},
	{"bpf_load_hdr_opt", "long", 0},
	{"bpf_store_hdr_opt", "long", 0},
	{"bpf_reserve_hdr_opt", "long", 0},
	{"bpf_inode_storage_get", "void *", FUNC_RET_PTR},
	{"bpf_inode_storage_delete", "int", FUNC_NEEDS_SIGN_EXT},
	{"bpf_d_path", "long", 0},
	{"bpf_copy_from_user", "long", 0},
	{"bpf_snprintf_btf", "long", 0},
	{"bpf_seq_printf_btf", "long", 0},
	{"bpf_skb_cgroup_classid", "__u64", FUNC_CANT_FAIL},
	{"bpf_redirect_neigh", "long", 0},
	{"bpf_per_cpu_ptr", "void *", FUNC_RET_PTR},
	{"bpf_this_cpu_ptr", "void *", FUNC_RET_PTR},
	{"bpf_redirect_peer", "long", 0},
	{"bpf_task_storage_get", "void *", FUNC_RET_PTR},
	{"bpf_task_storage_delete", "long", 0},
	{"bpf_get_current_task_btf", "struct task_struct *", FUNC_RET_PTR},
	{"bpf_bprm_opts_set", "long", 0},
	{"bpf_ktime_get_coarse_ns", "__u64", FUNC_CANT_FAIL},
	{"bpf_ima_inode_hash", "long", 0},
	{"bpf_sock_from_file", "struct socket *", FUNC_RET_PTR},
	{"bpf_check_mtu", "long", 0},
	{"bpf_for_each_map_elem", "long", 0},
	{"bpf_snprintf", "long", 0},
	{"bpf_sys_bpf", "long", 0},
	{"bpf_btf_find_by_name_kind", "long", 0},
	{"bpf_sys_close", "long", 0},
	{"bpf_timer_init", "long", 0},
	{"bpf_timer_set_callback", "long", 0},
	{"bpf_timer_start", "long", 0},
	{"bpf_timer_cancel", "long", 0},
	{"bpf_get_func_ip", "__u64", FUNC_CANT_FAIL},
	{"bpf_get_attach_cookie", "__u64", FUNC_CANT_FAIL},
	{"bpf_task_pt_regs", "struct pt_regs *", FUNC_RET_PTR},
	{"bpf_get_branch_snapshot", "long", 0},
	{"bpf_trace_vprintk", "long", 0},
	{"bpf_skc_to_unix_sock", "struct unix_sock*", 0},
	{"bpf_kallsyms_lookup_name", "long", 0},
	{"bpf_find_vma", "long", 0},
	{"bpf_loop", "long", 0},
	{"bpf_strncmp", "long", FUNC_CANT_FAIL},
	{"bpf_get_func_arg", "long", 0},
	{"bpf_get_func_ret", "long", 0},
	{"bpf_get_func_arg_cnt", "long", 0},
	{"bpf_get_retval", "int", FUNC_NEEDS_SIGN_EXT},
	{"bpf_set_retval", "int", FUNC_NEEDS_SIGN_EXT},
	{"bpf_xdp_get_buff_len", "__u64", FUNC_CANT_FAIL},
	{"bpf_xdp_load_bytes", "long", 0},
	{"bpf_xdp_store_bytes", "long", 0},
	{"bpf_copy_from_user_task", "long", 0},
	{"bpf_skb_set_tstamp", "long", 0},
	{"bpf_ima_file_hash", "long", 0},
	{"bpf_kptr_xchg", "void *", FUNC_RET_PTR},
	{"bpf_map_lookup_percpu_elem", "void *", FUNC_RET_PTR},
	{"bpf_skc_to_mptcp_sock", "struct mptcp_sock *", FUNC_RET_PTR},
	{"bpf_dynptr_from_mem", "long", 0},
	{"bpf_ringbuf_reserve_dynptr", "long"},
	{"bpf_ringbuf_submit_dynptr", "void", FUNC_CANT_FAIL | FUNC_RET_VOID},
	{"bpf_ringbuf_discard_dynptr", "void", FUNC_CANT_FAIL | FUNC_RET_VOID},
	{"bpf_dynptr_read", "long", 0},
	{"bpf_dynptr_write", "long", 0},
	{"bpf_dynptr_data", "void *", FUNC_RET_PTR},
	{"bpf_tcp_raw_gen_syncookie_ipv4", "__s64", 0},
	{"bpf_tcp_raw_gen_syncookie_ipv6", "__s64", 0},
	{"bpf_tcp_raw_check_syncookie_ipv4", "long", 0},
	{"bpf_tcp_raw_check_syncookie_ipv6", "long", 0},
	{"bpf_ktime_get_tai_ns", "__u64", FUNC_CANT_FAIL},
	{"bpf_user_ringbuf_drain", "long", 0},
	{"bpf_cgrp_storage_get", "void *", FUNC_RET_PTR},
	{"bpf_cgrp_storage_delete", "long", 0},
};
...
int func_flags(const char *func_name, const struct btf *btf, int btf_id)
{
	...
	for (int i = 0; i < ARRAY_SIZE(bpf_helper_defs); i++) {
		struct bpf_helper_def *def = &bpf_helper_defs[i];

		if (strcmp(def->name, func_name) != 0)
			continue;
